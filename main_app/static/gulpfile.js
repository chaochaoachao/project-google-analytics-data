...
gulp.task('replacePath', function(){
    var replacePath1 = gulp.src(['../templates/*/*.html'], { base: "./" })
        .pipe(replace('="images/', '="../../images/'))
        .pipe(replace('href=templates/', 'href="../templates/'))
        .pipe(replace('href="docs/', 'href="../../docs/'))
        .pipe(replace('href="index.html"', 'href="../templates/index.html"'))
        .pipe(gulp.dest('.'));
    var replacePath2 = gulp.src(['./templates/*.html'], { base: "./" })
